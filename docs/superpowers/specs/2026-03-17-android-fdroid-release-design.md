...
### Package ID
`software.tradeinsight.chess3000`
...
**File path in fdroiddata:** `metadata/software.tradeinsight.chess3000.yml`
...
2. Add `metadata/software.tradeinsight.chess3000.yml`
3. Run `fdroid lint metadata/software.tradeinsight.chess3000.yml` locally to validate
